...
class IntegerRightTriangle {
    ...
    /* According to Euclid's Formula for Pythagorean Triples, 
       ...
       b = k * 2mn
       c = k * (m^2 + n^2)
       where k >= 1, m > n, either m or n is even and m, n are coprime.
...
public class euler_75_singular_integer_right_triangles {
    ...
    public static void main(String[] args)
    {
        ...
        //System.out.println(IntegerRightTriangle.coprime(279, 166));
        IntegerRightTriangle.findSides(length);
        System.out.println(IntegerRightTriangle.perimeters);
        System.out.println(IntegerRightTriangle.countSingular());
        System.out.println(IntegerRightTriangle.singulars);
    }
}
