...
public class problem50 
{
    ...
    public static void main(String[] args)
    {
        if (args.length > 0)
        {
            ...
            if (limit <= 2) 
            {
                System.out.println("The input limit cannot be 2 or lower, since 2 is the first prime number.");
                return ;
            }
        }
        ...
        System.out.println("Longest sum of consecutive primes: " + primeSum.sum);
    }
}